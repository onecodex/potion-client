...
class Client(object):
    ...
    def __init__(self, base_url="http://localhost", schema_path="/schema", extensions=None, **requests_kwargs):
        ...
        for name, desc in self._schema[PROPERTIES].items():
            ...
            resource = Resource.factory(desc.get(DOC, ""), name, class_schema, requests_kwargs, self, extensions)
